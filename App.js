...
import {ImageBackground, ScrollView, StyleSheet, Text, View, FlatList} from 'react-native';
...
const itemBuilder = ({item})=>{
  return (
    ...
    <Text style={{fontSize: 20}}><Text style={{fontWeight: 'bold'}}>{item.textBold} </Text> {item.textN}</Text>
    </RoundedContainer>
  )
}
